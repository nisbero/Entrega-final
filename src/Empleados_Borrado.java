	...
	/**
	 * Clase que representa la interfaz para borrar empleados.
	 */
public class Empleados_Borrado extends javax.swing.JFrame {

			/**
		     * Creates new form
		     */
		    public Empleados_Borrado() {
		        initComponents();
		    }
		    ...
		    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
		        try {
		        	...
		        	String mensaje = "Empleados Borrado" + "-" + txtempl_ID.getText();  
		    ...
		    public static void main(String args[]) {
		        ...
		        try {
		            ...
		            java.util.logging.Logger.getLogger(Empleados_Borrado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		        ...
		        java.awt.EventQueue.invokeLater(new Runnable() {
		            public void run() {
		                new Empleados_Borrado().setVisible(true);
		            }
		        });
		    }
